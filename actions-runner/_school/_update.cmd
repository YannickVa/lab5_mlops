...
setlocal
set runnerpid=126788
set runnerprocessname=Runner.Listener.exe
set rootfolder=C:\Users\yanni\Projects\lab5_github\actions-runner
set existrunnerversion=2.311.0
set downloadrunnerversion=2.325.0
set logfile=C:\Users\yanni\Projects\lab5_github\actions-runner\_diag\SelfUpdate-20250607-094439.log
...
if %restartinteractiverunner% equ 1 (
  ...
  endlocal
  start "Actions Runner" cmd.exe /k "C:\Users\yanni\Projects\lab5_github\actions-runner\run.cmd"
) else (
  endlocal
)
